    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          <p class="api-note">POS~/api/simulation/create</p>
          <p class="description">
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          <p class="api-note">POS~/api/simulation/prepare</p>
          <p class="description">
      ...
      <div class="step-card" :class="{ 'active': phase === 4 }">
        ...
        <div class="card-content">
          <p class="api-note">POS~/api/simulation/start</p>
...
// Using useTaskPolling composable instead of manual timers
...
const startPollingTask = () => {
  startPolling('prepare', pollPrepareStatus, 2000)
}
...
const startProfilesPolling = () => {
  startPolling('profiles', fetchProfilesRealtime, 3000)
}

const stopProfilesPolling = () => {
  stopPolling('profiles')
}
...
const startConfigPolling = () => {
  startPolling('config', fetchConfigRealtime, 2000)
}
...
.badge.success { background: rgba(23, 201, 100, 0.1); color: var(--accent-success); }
.badge.processing { background: var(--text-primary); color: var(--bg-base); }
.badge.pending { background: var(--bg-panel-hover); color: var(--text-muted); }
