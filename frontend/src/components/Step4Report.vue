    ...
    <div class="report-panel">
        ...
        <div class="main-split-layout">
                    ...
                    <div class="sections-list">
                        <div
                            ...
                            :class="{
                                ...
                                'is-pending':
                                    !isSectionCompleted(idx + 1) && currentSectionIndex !== idx + 1,
                            }"
                        >
                            <div
            ...
            <div class="right-panel" ref="rightPanel">
                <div
                    class="panel-header"
                    :class="`panel-header--${activeStep.status}`"
                    v-if="!isCompleted"
                >
                    ...
                    <span class="header-meta mono" v-if="activeStep.meta">{{
                        activeStep.meta
                    }}</span>
                </div>
                ...
                <div class="workflow-overview" v-if="agentLogs.length > 0 || reportOutline">
                    <div class="workflow-metrics">
                        ...
                        <div class="metric metric-right">
                            <span class="metric-pill" :class="`pill--${statusClass}`">{{
                                statusText
                            }}</span>
                        </div>
                    </div>
                        ...
                        >
                            ...
                            <div class="wf-step-content">
                                <div class="wf-step-title-row">
                                    ...
                                    <span class="wf-step-meta mono" v-if="step.meta">{{
                                        step.meta
                                    }}</span>
                                </div>
                            </div>
                    ...
                    <button v-if="isCompleted" class="next-step-btn" @click="goToInteraction">
                        <span>进入深度互动</span>
                        <svg
                            viewBox="0 0 24 24"
                            width="16"
                ...
                <div class="workflow-timeline">
                    <TransitionGroup name="timeline-item">
                        ...
                        >
                            ...
                            <div class="timeline-connector">
                                <div
                                    class="connector-dot"
                                    :class="getConnectorClass(log, idx, displayLogs.length)"
                                ></div>
                                <div
                                    class="connector-line"
                                    v-if="idx < displayLogs.length - 1"
                                ></div>
                            </div>
                            ...
                            <div class="timeline-content">
                                ...
                                <div
                                    class="timeline-body"
                                    :class="{ collapsed: isLogCollapsed(log) }"
                                ...
                                >
                                    ...
                                    <template v-if="log.action === 'report_start'">
                                        ...
                                        <div
                                            class="info-row"
                                            v-if="log.details?.simulation_requirement"
                                        >
                                    ...
                                    <template v-if="log.action === 'planning_start'">
                                        <div class="status-message planning">
                                            {{ log.details?.message }}
                                        </div>
                                    </template>
                                    <template v-if="log.action === 'planning_complete'">
                                        ...
                                        <div class="outline-badge" v-if="log.details?.outline">
                                            {{ log.details.outline.sections?.length || 0 }} sections
                                            planned
                                        </div>
                                    </template>
                                    ...
                                    <template v-if="log.action === 'tool_call'">
                                        <div
                                            class="tool-badge"
                                            :class="'tool-' + getToolColor(log.details?.tool_name)"
                                        >
                                            <!-- Deep Insight - Lightbulb -->
                                            <svg
                                                v-if="
                                                    getToolIcon(log.details?.tool_name) ===
                                                    'lightbulb'
                                                "
                                                class="tool-icon"
                                                viewBox="0 0 24 24"
                                            ...
                                            <svg
                                                v-else-if="
                                                    getToolIcon(log.details?.tool_name) === 'globe'
                                                "
                                                class="tool-icon"
                                                viewBox="0 0 24 24"
                                                width="14"
                                            ...
                                            <svg
                                                v-else-if="
                                                    getToolIcon(log.details?.tool_name) === 'users'
                                                "
                                                class="tool-icon"
                                                viewBox="0 0 24 24"
                                                width="14"
                                            ...
                                            <svg
                                                v-else-if="
                                                    getToolIcon(log.details?.tool_name) === 'zap'
                                                "
                                                class="tool-icon"
                                                viewBox="0 0 24 24"
                                                width="14"
                                            ...
                                            <svg
                                                v-else-if="
                                                    getToolIcon(log.details?.tool_name) === 'chart'
                                                "
                                                class="tool-icon"
                                                viewBox="0 0 24 24"
                                                width="14"
                                    ...
                                    <template v-if="log.action === 'tool_result'">
                                        <div
                                            ...
                                            :class="'result-' + log.details?.tool_name"
                                        >
                                            ...
                                            <div
                                                v-if="
                                                    ![
                                                        ...
                                                        'panorama_search',
                                                        'quick_search',
                                                    ].includes(log.details?.tool_name)
                                                "
                                                class="result-meta"
                                            >
                                                ...
                                                <span class="result-size">{{
                                                    formatResultSize(log.details?.result_length)
                                                }}</span>
                                            </div>
                                            ...
                                            >
                                                ...
                                                >
                                                    <InterviewDisplay
                                                        :result="parseInterview(log.details.result)"
                                                ...
                                                <template
                                                    v-else-if="
                                                        log.details?.tool_name === 'insight_forge'
                                                    "
                                                >
                                                    <InsightDisplay
                                                        :result="
                                                            parseInsightForge(log.details.result)
                                                        "
                                                        :result-length="log.details?.result_length"
                                                    />
                                                </template>
                                                ...
                                                <template
                                                    v-else-if="
                                                        log.details?.tool_name === 'panorama_search'
                                                    "
                                                >
                                                    <PanoramaDisplay
                                                        :result="parsePanorama(log.details.result)"
                                                        :result-length="log.details?.result_length"
                                                    />
                                                </template>
                                                ...
                                                <template
                                                    v-else-if="
                                                        log.details?.tool_name === 'quick_search'
                                                    "
                                                >
                                                    <QuickSearchDisplay
                                                        :result="
                                                            parseQuickSearch(log.details.result)
                                                        "
                                                        :result-length="log.details?.result_length"
                                                    />
                                                </template>
                                    ...
                                    <template v-if="log.action === 'llm_response'">
                                        <div class="llm-meta">
                                            <span class="meta-tag"
                                                >Iteration {{ log.details?.iteration }}</span
                                            >
                                            <span
                                                class="meta-tag"
                                                :class="{ active: log.details?.has_tool_calls }"
                                            >
                                                Tools:
                                                {{ log.details?.has_tool_calls ? 'Yes' : 'No' }}
                                            </span>
                                            <span
                                                class="meta-tag"
                                                :class="{
                                                    active: log.details?.has_final_answer,
                                                    'final-answer': log.details?.has_final_answer,
                                                }"
                                            >
                                                Final:
                                                {{ log.details?.has_final_answer ? 'Yes' : 'No' }}
                                            </span>
                                        </div>
                                        <!-- 当是最终答案时，显示特殊提示 -->
                                        <div
                                            v-if="log.details?.has_final_answer"
                                            class="final-answer-hint"
                                        >
                                            <svg
                                                viewBox="0 0 24 24"
                                                width="14"
                                            ...
                                            <span
                                                >Section "{{ log.section_title }}" content
                                                generated</span
                                            >
                                        </div>
                                        <div
                                ...
                                <div
                                    ...
                                    "
                                >
                                    <span v-if="log.elapsed_seconds" class="elapsed-badge"
                                        >+{{ log.elapsed_seconds.toFixed(1) }}s</span
                                    >
                    ...
                    <!-- Empty State -->
                    <div v-if="agentLogs.length === 0 && !isCompleted" class="workflow-empty">
        ...
        <div class="console-logs">
            ...
            <div class="log-content" ref="logContent">
                <div class="log-line" v-for="(log, idx) in consoleLogs" :key="idx">
                    <span class="log-msg" :class="getLogLevelClass(log)">{{
        ...
        return () =>
            h('div', { class: 'insight-display' }, [
                ...
                h('div', { class: 'insight-header' }, [
                    h('div', { class: 'header-main' }, [
                        ...
                        h('div', { class: 'header-stats' }, [
                            ...
                            props.resultLength &&
                                h('span', { class: 'stat-size' }, formatSize(props.resultLength)),
                        ]),
                    ]),
                    ...
                    h(
                        ...
                        [
                            h(
                                'span',
                                { class: 'tab-label' },
                                `当前关键记忆 (${props.result.facts.length})`
                            ),
                        ]
                    ),
                    h(
                        ...
                        [
                            h(
                                'span',
                                { class: 'tab-label' },
                                `核心实体 (${props.result.entities.length})`
                            ),
                        ]
                    ),
                    h(
                        ...
                        [
                            h(
                                'span',
                                { class: 'tab-label' },
                                `关系链 (${props.result.relations.length})`
                            ),
                        ]
                    ),
                        ...
                        h(
                            ...
                            [
                                h(
                                    'span',
                                    { class: 'tab-label' },
                                    `子问题 (${props.result.subQueries.length})`
                                ),
                            ]
                        ),
                ]),
                ...
                h('div', { class: 'insight-content' }, [
                        ...
                        h('div', { class: 'relations-panel' }, [
                            h('div', { class: 'panel-header' }, [
                                ...
                                h(
                                    'span',
                                    { class: 'panel-count' },
                                    `共 ${props.result.relations.length} 条`
                                ),
                            ]),
                            h(
                                'div',
                            ...
                            props.result.relations.length > INITIAL_SHOW_COUNT &&
                                h(
                                    ...
                                    expandedRelations.value
                                        ? `收起 ▲`
                                        : `展开全部 ${props.result.relations.length} 条 ▼`
                                ),
                        ]),
                        ...
                        h('div', { class: 'subqueries-panel' }, [
                            h('div', { class: 'panel-header' }, [
                                ...
                                h(
                                    'span',
                                    { class: 'panel-count' },
                                    `共 ${props.result.subQueries.length} 个`
                                ),
                            ]),
                            h(
                                'div',
                    ...
                    activeTab.value === 'facts' &&
                        props.result.facts.length === 0 &&
                        h('div', { class: 'empty-state' }, '暂无当前关键记忆'),
                    activeTab.value === 'entities' &&
                        props.result.entities.length === 0 &&
                        h('div', { class: 'empty-state' }, '暂无核心实体'),
                    activeTab.value === 'relations' &&
                        props.result.relations.length === 0 &&
                        h('div', { class: 'empty-state' }, '暂无关系链'),
                ]),
            ]);
    },
};
                    ...
                    h(
                        ...
                        [
                            h(
                                'span',
                                { class: 'tab-label' },
                                `当前有效记忆 (${props.result.activeFacts.length})`
                            ),
                        ]
                    ),
                    h(
                        ...
                        [
                            h(
                                'span',
                                { class: 'tab-label' },
                                `历史记忆 (${props.result.historicalFacts.length})`
                            ),
                        ]
                    ),
                    h(
                        ...
                        [
                            h(
                                'span',
                                { class: 'tab-label' },
                                `涉及实体 (${props.result.entities.length})`
                            ),
                        ]
                    ),
                ]),
                        ...
                        h('div', { class: 'facts-panel active-facts' }, [
                            h('div', { class: 'panel-header' }, [
                                ...
                                h(
                                    'span',
                                    { class: 'panel-count' },
                                    `共 ${props.result.activeFacts.length} 条`
                                ),
                            ]),
                            ...
                            props.result.activeFacts.length > INITIAL_SHOW_COUNT &&
                                h(
                                    ...
                                    expandedActive.value
                                        ? `收起 ▲`
                                        : `展开全部 ${props.result.activeFacts.length} 条 ▼`
                                ),
                        ]),
                        ...
                        h('div', { class: 'facts-panel historical-facts' }, [
                            h('div', { class: 'panel-header' }, [
                                ...
                                h(
                                    'span',
                                    { class: 'panel-count' },
                                    `共 ${props.result.historicalFacts.length} 条`
                                ),
                            ]),
                            ...
                            props.result.historicalFacts.length > INITIAL_SHOW_COUNT &&
                                h(
                                    ...
                                    expandedHistorical.value
                                        ? `收起 ▲`
                                        : `展开全部 ${props.result.historicalFacts.length} 条 ▼`
                                ),
                        ]),
                    ...
                    h('div', { class: 'interview-detail' }, [
                        ...
                        h('div', { class: 'agent-profile' }, [
                            h(
                                ...
                                props.result.interviews[activeIndex.value]?.name?.charAt(0) || 'A'
                            ),
...
const activeSectionIndex = computed(() => {
    ...
    if (totalSections.value > 0 && completedSections.value < totalSections.value)
...
const workflowSteps = computed(() => {
    ...
    sections.forEach((section, i) => {
        const idx = i + 1;
        const status =
            isCompleted.value || !!generatedSections.value[idx]
                ? 'done'
    ...
    // Complete
    const completeStatus = isCompleted.value ? 'done' : isFinalizing.value ? 'active' : 'todo';
    steps.push({
        key: 'complete',
        noLabel: 'OK',
        title: 'Complete',
...
const getTimelineItemClass = (log, idx, total) => {
    const isLatest = idx === total - 1 && !isCompleted.value;
...
onMounted(() => {
    if (props.reportId) {
        emit('add-log', `Report Agent initialized: ${props.reportId}`);
    }
});
...
.header-dot {
    ...
    box-shadow: 0 0 0 3px var(--shadow-panel);
    margin-right: 10px;
    flex-shrink: 0;
...
@keyframes pulse-dot {
    ...
    50% {
        box-shadow: 0 0 0 5px var(--shadow-panel);
    }
}
...
.section-number {
    ...
    font-size: 16px;
    color: var(--text-muted); /* 深灰色，不随状态变化 */
    font-weight: 500;
}
...
.right-panel {
    ...
    --wf-border: var(--border-dim);
    --wf-divider: var(--bg-panel);

    --wf-active-bg: var(--bg-base);
    --wf-active-border: var(--text-primary);
    --wf-active-dot: var(--text-primary);
    --wf-active-text: var(--text-primary);

    --wf-done-bg: var(--bg-panel);
    --wf-done-border: var(--border-dim);
    --wf-done-dot: #10b981;

    --wf-muted-dot: var(--border-dim);
...
:deep(.insight-tab.active) {
    ...
    color: #7c3aed;
    border-color: var(--border-dim);
    box-shadow: 0 1px 2px var(--shadow-panel);
}
