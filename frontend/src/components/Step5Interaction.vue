                    ...
                    <div class="action-bar-tabs">
                        ...
                        <div class="agent-dropdown" v-if="profiles.length > 0">
                            ...
                            >
                                ...
                                <span>{{
                                    selectedAgent ? selectedAgent.username : '与世界中任意个体对话'
                                }}</span>
                                <svg
                        ...
                        <div class="tools-card-header">
                            ...
                            <div class="tools-card-info">
                                ...
                                <div class="tools-card-subtitle">
                                    报告生成智能体的快速对话版本，可调用 4
                                    种专业工具，拥有MiroFish的完整记忆
                                </div>
                            </div>
                            <button
                ...
                <div v-if="activeTab === 'survey'" class="survey-container">
                    ...
                    <div class="survey-setup">
                        ...
                        <button
                            ...
                            :disabled="
                                selectedAgents.size === 0 || !surveyQuestion.trim() || isSurveying
                            "
                            @click="submitSurvey"
                        >
...
.dropdown-menu {
    ...
    border-radius: 12px;
    box-shadow:
        0 12px 40px var(--shadow-panel),
        0 4px 12px var(--shadow-panel);
    max-height: 320px;
    overflow-y: auto;
    z-index: 100;
}
