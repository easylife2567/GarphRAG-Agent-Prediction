                                    ...
                                    >
                                        <div class="quote-header">
                                            ...
                                            <span class="quote-label"
                                                >@{{
                                                    action.action_args.original_author_name ||
                                                    'User'
                                                }}</span
                                            >
                                        </div>
...
const {
    ...
    allActions,
    phase,
    doStartSimulation: startSim,
    handleStopSimulation: stopSim,
    stopAllPolling,
} = useSimulation();
...
const handleStartSimulation = () => {
    if (props.simulationId) {
        startSim(props.simulationId, props.maxRounds, addLog, updateStatus);
    }
};
...
const handleStopSimulation = () => {
    if (props.simulationId) {
        stopSim(props.simulationId, addLog, updateStatus);
    }
};
...
.actions-tooltip::before {
    ...
    border-bottom: 6px solid var(--bg-panel-hover);
}
